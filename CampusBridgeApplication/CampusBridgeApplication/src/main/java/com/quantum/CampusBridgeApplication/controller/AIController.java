...
public class AIController {
    ...
    // Free and open model for text generation
    private final String HUGGINGFACE_URL = "https://api-inference.huggingface.co/models/HuggingFaceH4/zephyr-7b-alpha";
